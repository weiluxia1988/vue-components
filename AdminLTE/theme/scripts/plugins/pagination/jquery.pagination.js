 ...
 */
 (function($){
	...
	$.extend($.PaginationRenderers.defaultRenderer.prototype, {
		...
		createLink:function(page_id, current_page, appendopts){
			...
			if(page_id == current_page){
				lnk = $("<li class='active'><a href='javascript:;'>" + appendopts.text + "</a></li>");
			}
			else
			{
				lnk = $("<li><a href='"+this.opts.link_to.replace(/__id__/,page_id)+"'>" + appendopts.text + "</a></li>");
			}
			if(appendopts.classes){ lnk.find('a').addClass(appendopts.classes); }
			if(appendopts.rel){ lnk.find('a').attr('rel', appendopts.rel); }
	...
	$.fn.pagination = function(maxentries, opts){
		...
		$(this).data('maxentries', maxentries); // lulu
		opts.items_per_page = (!opts.items_per_page || opts.items_per_page < 0)?1:opts.items_per_page;
		$(this).data('items_per_page', opts.items_per_page); // lulu
